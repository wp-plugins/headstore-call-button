...
class Headstore_Config {
	...
	public function __construct() {
		...
		$this->plugin_name = 'headstore-config';
		$this->version = '1.0.0';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/headstore-config-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/headstore-config-i18n.php';
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/headstore-config-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/headstore-config-public.php';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'plugin_action_links_headstore-config/headstore-config.php', $plugin_admin, 'plugin_action_links');
