...
<div id="message-info-multiple-account" class="notice hs-notice">
		...
		<?php _e( 'To add additional experts to one account, please go to', $this->plugin_name); ?>  <a href="https://app.headstore.com/" class="hs-link" target="_blank"><?php _e( 'the HEADSTORE website', $this->plugin_name); ?></a> <?php _e( 'and login to manage your experts.', $this->plugin_name); ?> <br>
