...
function activate_headstore_config() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/headstore-config-activator.php';
...
function deactivate_headstore_config() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/headstore-config-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/headstore-config.php';
